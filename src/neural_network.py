...
class NeuralNetwork():
    ...
    def fit(self, x_train:np.ndarray, y_train:np.ndarray, epochs:int=1, learning_rate:float=0.001)->None:
        """Train the neural network with the training set x_train to approach y_train"""
        ...
        for i in range(epochs):
            ...
            print('Epoch : '+str(i)+' - loss : '+str(loss)+' - accuracy : '+str(accu))